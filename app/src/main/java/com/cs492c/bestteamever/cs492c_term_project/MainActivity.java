...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button oneTimePasswordButton = (Button) findViewById(R.id.oneTimePasswordButton);
        oneTimePasswordButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, oneTimePasswordActivity.class));
            }
        });
    ...
    private void startNFCService() {
        ...
        dialog.setContentView(R.layout.nfc_success_dialog);

        TextView text = (TextView) dialog.findViewById(R.id.nfcSuccesDialogText);
        text.setText(R.string.nfcSuccess);
